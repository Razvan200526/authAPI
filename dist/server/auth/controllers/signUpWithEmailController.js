...
export const signUpWithEmailController = async (c) => {
    try {
        ...
        if (newUser[0]) {
            ...
            return c.json({ accessToken: accessToken, message: 'User created successfully' }, 201);
        }
    }
    catch (error) {
...
//# sourceMappingURL=signUpWithEmailController.js.map